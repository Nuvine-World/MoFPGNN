...
def scaffold_split(data,
    ...
    :param data: A DataFrame with smiles column.
    ...
    #data_smiles = data.smiles.to_list()
    data_smiles = list(data.get('SMILES'))
    scaffold_to_indices = scaffold_to_smiles(data_smiles, use_indices=True)
    ...
    if train_scaffold_count == 0 or val_scaffold_count == 0 or test_scaffold_count == 0:
        train, val, test = scaffold_split(data, sizes, balanced, seed)
